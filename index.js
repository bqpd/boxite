...
"3. Open the hosting folder's *index.html* in a text-editor. Select *\"index.js\"* on line 14 and replace it with the link from the previous step (keeping the quote marks).\n"+
